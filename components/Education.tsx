        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2">
          {EDUCATION.map((e) => (
            <div
              key={e.school}
              data-reveal
              className="group relative flex items-stretch gap-7 overflow-hidden rounded-2xl border border-foam/10 bg-deep/20 p-9 transition-all duration-500 hover:-translate-y-1 hover:border-tide/40"
            >
              ...
              <img
                ...
                alt={e.school}
                loading="lazy"
                className="w-[88px] shrink-0 self-stretch rounded-xl border border-foam/10 object-cover transition-transform duration-500 group-hover:scale-[1.03]"
              />
