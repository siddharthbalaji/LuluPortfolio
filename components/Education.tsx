        ...
        <div className="mt-14 grid gap-5 md:grid-cols-2">
          {EDUCATION.map((e) => (
            <div
              key={e.school}
              data-reveal
              className="group relative overflow-hidden rounded-2xl border border-foam/10 bg-deep/20 p-9 transition-all duration-500 hover:-translate-y-1 hover:border-tide/40"
            >
