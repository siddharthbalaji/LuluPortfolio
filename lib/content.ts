...
export const XCARD = {
  ...
  // Hashtags shown beneath the post body — drawn from the themes of the
  // bio/quote above (product + motion design, AI-assisted workflow, craft).
  hashtags: [
    "ProductDesign",
    "UIUX",
    "MotionDesign",
...
export const EXPERIENCE: Job[] = [
  {
    ...
    bullets: [
      "Created and developed motion design concepts, including storyboards and animated sequences for an original series, establishing a consistent visual style and enhancing overall user engagement.",
...
export const EDUCATION = [
  {
    ...
    degree: "MA in Illustration & Animation",
...
export const BRAND = {
  intro: "LULU is a personal brand built on reflection, duality, and the poetry of Japanese form. It is also a nickname/alias that I commonly use.",
  steps: [
    {
      idx: "01",
      kicker: "Origin",
